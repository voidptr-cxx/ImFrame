...
- DX12: `BackdropBlur` parity work only, mirroring Vulkan's own Phase 35.6 — not yet started.
- WebGPU: `Shadow`/`Layer`/`BackdropBlur` parity work, mirroring Vulkan's own Phase 35.4-35.6 sequence — not yet started.

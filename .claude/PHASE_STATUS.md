...
- WebGPU: its own `BatchKind::Image`/`Shadow`/`Layer`/`BackdropBlur` parity work, mirroring Vulkan's own Phase 35.2/35.4-35.6 sequence — not yet started (WebGPU remains at "first SDF rect" only, Phase 35.8).

...
- WebGPU: `Shadow`/`Layer`/`BackdropBlur` parity work, mirroring Vulkan's own Phase 35.4-35.6 sequence — not yet started (its own `BatchKind::Image` sub-phase, 35.10, is the furthest WebGPU has reached so far).
